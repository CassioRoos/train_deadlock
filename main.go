...
import (
	"github.com/CassioRoos/train_deadlock/arbitrator"
...
func main() {
	...
	go arbitrator.MoveTrain(trains[0], 300, []*models.Crossing{{Position: 125, Intersection: intersections[0]},
		{Position: 175, Intersection: intersections[1]}})

	go arbitrator.MoveTrain(trains[1], 300, []*models.Crossing{{Position: 125, Intersection: intersections[1]},
		{Position: 175, Intersection: intersections[2]}})

	go arbitrator.MoveTrain(trains[2], 300, []*models.Crossing{{Position: 125, Intersection: intersections[2]},
		{Position: 175, Intersection: intersections[3]}})

	go arbitrator.MoveTrain(trains[3], 300, []*models.Crossing{{Position: 125, Intersection: intersections[3]},
